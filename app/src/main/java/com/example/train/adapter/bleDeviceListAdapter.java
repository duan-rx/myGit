...
public class bleDeviceListAdapter extends BaseAdapter {
    ...
    public bleDeviceListAdapter(Context context,List<List<String>> data){
        context= context;
        mData=data;
        myLayoutInflater=LayoutInflater.from(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mData != null) {
            ...
            holder.tv_uuid.setText(bleServer.get(0).toString());
            holder.tv_content.setText(bleServer.get(1).toString());
        }
        else {
